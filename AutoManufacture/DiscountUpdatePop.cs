...
{
    public partial class DiscountUpdatePop : Form
    {
        Form1 f1;
        public DiscountUpdatePop(Form1 frm1)
        {
            InitializeComponent();
            this.f1 = frm1;
        }
        ...
        private void txtDiscount_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
                ...
                {
                    int discount = int.Parse(txtDiscount.Text.ToString());
                    ...
                    foreach (DataGridViewRow row in f1.orderGridView.SelectedRows)
                    {
                        ...
                        float quantity = float.Parse(f1.orderGridView.Rows[index].Cells[3].Value.ToString());
                        float netmrp = quantity * mrp;
                        CalcDisc = netmrp * discount / 100;
                        ...
                        if (f1.orderGridView.Rows[index].Cells[3].Value != null)
                        {
                            ...
                            f1.orderGridView.Rows[index].Cells[5].Value = discount;
